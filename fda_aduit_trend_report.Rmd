...
tidy_citations <- rbind(true_503B, false_503B) %>%
  mutate(CFR = gsub("(\\([a-z]))|(\\([0-9]))", "", `CFR/Act Number`))
```

# Most Common Compliance Issues

Which guidances are most often cited to drug companies in general? Also consider looking at the full citation (subsections and all).
...
How about 503B companies?

Why has the regex not extracted all sections trapped in parenthesis?
...
# Citation Heatmap of America

Where are the 503B Companies Located? Create a heatmap of America outlining which states have the highest density of 503Bs (potentially relative to capita).
